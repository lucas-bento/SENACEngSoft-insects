...
const routes = [
    ...
    { path: 'layout', component: _containers_layout_layout_component__WEBPACK_IMPORTED_MODULE_3__["LayoutComponent"], children: [
            ...
            { path: 'insects', loadChildren: () => __webpack_require__.e(/*! import() | insects-insects-module */ "insects-insects-module").then(__webpack_require__.bind(null, /*! ../insects/insects.module */ "./src/app/insects/insects.module.ts")).then(mod => mod.InsectsModule) },
        ] },
];
